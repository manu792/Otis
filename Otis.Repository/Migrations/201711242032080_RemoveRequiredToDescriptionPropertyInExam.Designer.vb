...
Namespace Migrations
    ...
    Public NotInheritable Partial Class RemoveRequiredToDescriptionPropertyInExam
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(RemoveRequiredToDescriptionPropertyInExam))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201711242032080_RemoveRequiredToDescriptionPropertyInExam"
            End Get
        End Property
