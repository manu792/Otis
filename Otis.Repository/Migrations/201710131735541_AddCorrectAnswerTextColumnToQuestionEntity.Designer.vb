...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddCorrectAnswerTextColumnToQuestionEntity
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddCorrectAnswerTextColumnToQuestionEntity))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201710131735541_AddCorrectAnswerTextColumnToQuestionEntity"
            End Get
        End Property
