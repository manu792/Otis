...
Namespace Migrations
    ...
    Public NotInheritable Partial Class RemovedCorrectAnswerPropertyFromTestHistoryEntity
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(RemovedCorrectAnswerPropertyFromTestHistoryEntity))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201711132217562_RemovedCorrectAnswerPropertyFromTestHistoryEntity"
            End Get
        End Property
