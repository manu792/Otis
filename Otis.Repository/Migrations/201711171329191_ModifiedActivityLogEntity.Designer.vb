...
Namespace Migrations
    ...
    Public NotInheritable Partial Class ModifiedActivityLogEntity
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ModifiedActivityLogEntity))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201711171329191_ModifiedActivityLogEntity"
            End Get
        End Property
