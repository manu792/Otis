...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddObservation
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddObservation))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201711192332030_AddObservation"
            End Get
        End Property
