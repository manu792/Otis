...
Namespace Migrations
    ...
    Public NotInheritable Partial Class ChangeSessionEntityPropertyFromTestDateToSessionDate
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(ChangeSessionEntityPropertyFromTestDateToSessionDate))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201710011444077_ChangeSessionEntityPropertyFromTestDateToSessionDate"
            End Get
        End Property
