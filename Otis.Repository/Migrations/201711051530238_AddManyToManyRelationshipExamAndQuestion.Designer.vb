...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddManyToManyRelationshipExamAndQuestion
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddManyToManyRelationshipExamAndQuestion))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201711051530238_AddManyToManyRelationshipExamAndQuestion"
            End Get
        End Property
